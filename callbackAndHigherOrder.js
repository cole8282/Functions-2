...
// CODE HERE
const uniq = function(array, callback) {
...
// CODE HERE
console.log(uniq(names, function(uniqArr) {
  //console.log(uniqArr);
...
// CODE HERE
const each = function(arrayOfNames, callback) {
  for (let i = 0; i < arrayOfNames.length; i++) {
    console.log(callback(arrayOfNames[i], i));
  }
}
...
// CODE HERE
const getUserById = function(arrayOfObjs, id, callback) {
  for (var i = 0; i < arrayOfObjs.length; i++) {
    if (id === arrayOfObjs[i]['id']) {
